...
<p>
  ...
  🔷️ In a **Server-Client System**, a **host computer** or **Server** makes a folder(s) available, and client devices (computers) can access, read, or modify files based on set permissions. 

In **P2P** sharing, devices share files directly with each other without a central server. 
